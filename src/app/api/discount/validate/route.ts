...
import { createConfiguredRateLimiter } from '@/lib/rateLimit';

export const runtime = 'nodejs';

// Module-level, one per instance. Upstash-backed (shared across instances)
// when UPSTASH_REDIS_REST_URL/TOKEN are set; per-instance memory otherwise —
// fine single-region, multiplies silently beyond that.
const limiter = createConfiguredRateLimiter({ limit: 10, windowMs: 60_000 });
